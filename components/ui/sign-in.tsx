...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn("h-full relative w-full opacity-50", containerClassName)}> {/* Removed bg-white */}
                ...
                {step === "email" ? (
                  ...
                  >
                    ...
                    <p className="text-xs text-white/40 pt-10">
                      By signing up, you agree to the <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Terms of Service</Link>, <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Privacy Policy</Link>.
                    </p>
                  </motion.div>
                ) : step === "code" ? (
                  <motion.div 
