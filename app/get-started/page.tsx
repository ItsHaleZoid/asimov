    ...
    try {
      ...
      if (password.length < 6) {
        ...
        if (error) {
          ...
          // Check if user is immediately signed in (autoconfirm enabled)
          if (data.session) {
                    ...
                    <div className="space-y-4">
                      <BlurFade delay={0.2} inView>
                        <button 
                          ...
                          disabled={loading}
                          className="backdrop-blur-[2px] w-5/8 mx-auto flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white border border-white/10 rounded-full py-3 px-4 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                      ...
                      <BlurFade delay={0.3} inView>
                        <div className="flex items-center gap-4 w-5/8 mx-auto">
                      ...
                      <BlurFade delay={0.4} inView>
                        <form onSubmit={handleAuthSubmit} className="space-y-4 w-5/8 mx-auto">
                          <input 
                            type="email" 
                        ...
                        {error && (
                          <div className={`mt-4 p-3 w-5/8 mx-auto ${
                        ...
                        <div className="mt-6 text-center">
                          <p className="text-white/60 text-sm">
                            ...
                            <Link href="/signin" className="text-white underline hover:text-white/80 transition-colors">
                              Sign in here
                            </Link>
                          </p>
                        </div>
